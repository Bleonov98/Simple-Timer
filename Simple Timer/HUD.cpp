...
HUDobject::HUDobject(unsigned int width, unsigned int height)
{
    this->width = width;
    this->height = height;
...
void HUDobject::DrawHUD(glm::vec2 pos, glm::vec2 size, bool menu)
{
    ResourceManager::GetShader("objectShader").Use();
    ResourceManager::GetShader("objectShader").SetMatrix4("projection", projection);
    ResourceManager::GetShader("objectShader").SetVector3f("objectColor", glm::vec3(1.0f));

    ResourceManager::GetShader("objectShader").SetBool("menu", menu);
